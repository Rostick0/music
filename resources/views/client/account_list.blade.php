    ...
    <div class="">
        <form class="admin-filter" action="{{ url()->current() }}">
            <div class="admin-filter__inputs">
                <input class="admin-input" type="search" placeholder="Title" name="title"
        ...
        <a class="admin-button admin-button-add" href="{{ route('client.account.create') }}">
            <span>Create</span>
        ...
        <ul class="admin-grid__content admin-grid-account__content">
            @foreach ($accounts as $account)
                <li class="admin-grid__content_item admin-grid-account__content_item">
                    ...
                    <a class="admin-button admin-button-edit" href="{{ route('client.account.edit', ['id' => $account->id]) }}">
