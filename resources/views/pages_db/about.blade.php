@extends("layout.front.index")
        ...
        <div class="container">
            <div class="about__container">
                ...
                <h1 class="section-title about__subtitle">About Subtitle</h1>
                <p class="section-description about__description">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Optio suscipit esse, maiores nihil dolores ipsam omnis quibusdam mollitia quod possimus eligendi
                    voluptate exercitationem qui harum facere vero assumenda id error.</p>
                <ul class="about__founder">
                    <li class="about__founder_item founder-item lazy entered" data-ll-status="entered">
                        <div class="founder-item__image">
                            <img class="founder-item__img lazy entered loaded" data-src="https://enthalpy.com/wp-content/uploads/2018/01/default-avatar.jpg" alt="" data-ll-status="loaded" src="https://enthalpy.com/wp-content/uploads/2018/01/default-avatar.jpg">
                        </div>
                        <ul class="founder-item__social">
                            <li class="founder-item__social_item">
                                <a class="founder-item__social_href" target="_blank" rel="noopener noreferrer" href="">
                                ...
                                <a class="founder-item__social_href" target="_blank" rel="noopener noreferrer" href="">
                                    <svg width="24" height="24" viewBox="0 0 41 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_88_23)">
                                            <path d="M16.7012 39.8C7.20122 38.1 0.0012207 29.9 0.0012207 20C0.0012207 9 9.00122 0 20.0012 0C31.0012 0 40.0012 9 40.0012 20C40.0012 29.9 32.8012 38.1 23.3012 39.8L22.2012 38.9H17.8012L16.7012 39.8Z" fill="url(#paint0_linear_88_23)"></path>
                                            <path d="M27.8013 25.5998L28.7013 19.9998H23.4013V16.0998C23.4013 14.4998 24.0013 13.2998 26.4013 13.2998H29.0013V8.1998C27.6013 7.9998 26.0013 7.7998 24.6013 7.7998C20.0013 7.7998 16.8013 10.5998 16.8013 15.5998V19.9998H11.8013V25.5998H16.8013V39.6998C17.9013 39.8998 19.0013 39.9998 20.1013 39.9998C21.2013 39.9998 22.3013 39.8998 23.4013 39.6998V25.5998H27.8013Z" fill="white"></path>
                                        </g>
                                        <defs>
                                            <linearGradient id="paint0_linear_88_23" x1="20.0022" y1="38.6089" x2="20.0022" y2="-0.00736777" gradientUnits="userSpaceOnUse">
                                                <stop stop-color="#0062E0"></stop>
                                                <stop offset="1" stop-color="#19AFFF"></stop>
                                            </linearGradient>
                                            <clipPath id="clip0_88_23">
                                                <rect width="40" height="40" fill="white" transform="translate(0.0012207)"></rect>
                                            </clipPath>
                                        </defs>
                                    </svg>
                                </a>
                    ...
                    <li class="about__founder_item founder-item lazy entered" data-ll-status="entered">
                        <div class="founder-item__image">
                            <img class="founder-item__img lazy entered loaded" data-src="https://mykaleidoscope.ru/x/uploads/posts/2022-09/1663141551_1-mykaleidoscope-ru-p-belorussiya-minsk-krasivo-1.jpg" alt="" data-ll-status="loaded" src="https://mykaleidoscope.ru/x/uploads/posts/2022-09/1663141551_1-mykaleidoscope-ru-p-belorussiya-minsk-krasivo-1.jpg">
                        </div>
                        <ul class="founder-item__social">
                            <li class="founder-item__social_item">
                                <a class="founder-item__social_href" target="_blank" rel="noopener noreferrer" href="">
                ...
                <div class="about__info">
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Obcaecati inventore non cumque tempora sequi,
                    animi adipisci ullam aut esse a dolor expedita quibusdam blanditiis earum minus. Aliquam vitae sit
                    nostrum.
                </div>
            </div>
        </div>
