        ...
        <div class="container">
            <div class="about__container">
                ...
                <ul class="about__founder">
                    <li class="about__founder_item founder-item lazy">
                        <div class="founder-item__image">
                            <img class="founder-item__img lazy"
                                data-src="https://enthalpy.com/wp-content/uploads/2018/01/default-avatar.jpg"
                                alt="">
                        </div>
