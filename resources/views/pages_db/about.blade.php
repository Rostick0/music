                ...
                <ul class="about__founder">
                    <li class="about__founder_item founder-item lazy entered" data-ll-status="entered">
                        <div class="founder-item__image">
                            <img class="founder-item__img lazy entered loaded"
                                data-src="https://enthalpy.com/wp-content/uploads/2018/01/default-avatar.jpg" alt=""
                                data-ll-status="loaded"
                                src="https://enthalpy.com/wp-content/uploads/2018/01/default-avatar.jpg">
                        </div>
                        <ul class="founder-item__social">
                            <li class="founder-item__social_item">
                                <a class="founder-item__social_href" target="_blank" rel="noopener noreferrer"
                                    href="">
                            ...
                            <li class="founder-item__social_item">
                                <a class="founder-item__social_href" target="_blank" rel="noopener noreferrer"
                                    href="">
                                    <svg width="24" height="24" viewBox="0 0 41 40" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                        ...
                                        <defs>
                                            ...
                                            <clipPath id="clip0_88_23">
                                                <rect width="40" height="40" fill="white"
                                                    transform="translate(0.0012207)"></rect>
                                            </clipPath>
                                        </defs>
                                    </svg>
                                </a>
                    ...
                    <li class="about__founder_item founder-item lazy entered" data-ll-status="entered">
                        <div class="founder-item__image">
                            <img class="founder-item__img lazy entered loaded"
                                data-src="https://mykaleidoscope.ru/x/uploads/posts/2022-09/1663141551_1-mykaleidoscope-ru-p-belorussiya-minsk-krasivo-1.jpg"
                                alt="" data-ll-status="loaded"
                                src="https://mykaleidoscope.ru/x/uploads/posts/2022-09/1663141551_1-mykaleidoscope-ru-p-belorussiya-minsk-krasivo-1.jpg">
                        </div>
                        <ul class="founder-item__social">
                            <li class="founder-item__social_item">
                                <a class="founder-item__social_href" target="_blank" rel="noopener noreferrer"
