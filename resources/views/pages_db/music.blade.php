                    ...
                    <div class="track__image">
                        <div class="track__image_inner">
                            <img class="track__img lazy"
                                data-src="{{ App\Http\Controllers\ImageController::getViewImage($music->image) }}"
                                alt="">
                        </div>
                    </div>
                        ...
                        <div class="track-version__item track-item">
                            ...
                            <div class="track-item__buttons">
                                ...
                                <a class="track-item__download"
                                    href="{{ App\Http\Controllers\MusicDownloadController::getLink($music->link, $music->link_demo, $music->is_free) }}"
                                    download>
                                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
