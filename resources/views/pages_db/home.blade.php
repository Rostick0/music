...
@section('html')
    ...
    <section class="section playlist">
        <div class="container">
            ...
            <a class="button-white-border button__all playlist__all" href="">See all playlists</a>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <ul class="tracks__list">
                <li class="tracks__item track-item">
                    <img class="track-item__img" src="/img/music.png" alt="">
                    <div class="track-item__info">
                        <div class="track-item__free">FREE</div>
                        <div class="track-item__name">It's Time For Her To Say Goodbye</div>
                        <div class="track-item__artist">Nine Lives</div>
                    </div>
                    <div class="track-item__application">
                        ...
                        <div class="track-time track-item__time">4:32</div>
                        <div class="track-item__audio"></div>
                    </div>
                ...
                <li class="tracks__item track-item">
                    ...
                    <div class="track-item__application">
                        ...
                        <div class="track-time track-item__time">4:32</div>
                        <div class="track-item__audio _2"></div>
                    </div>
                    <div class="track-item__buttons">
                        <button class="track-item__favorite">
                            <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                ...
                <li class="tracks__item track-item">
                    ...
                    <div class="track-item__application">
                        ...
                        <div class="track-time track-item__time">4:32</div>
                        <div class="track-item__audio _3"></div>
                    </div>
                    <div class="track-item__buttons">
                        <button class="track-item__favorite">
                            <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
            ...
            <a class="button-white-border button__all tracks__all" href="">Show more</a>
    </section>
