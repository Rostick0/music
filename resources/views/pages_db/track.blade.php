            ...
            <div class="container">
                <div class="track__info">
                    <div class="track__image">
                        <div class="track__image_inner">
                            <img class="track__img lazy entered error" data-src="{{ App\Http\Controllers\ImageController::getViewImage($music->image) }}" alt="" data-ll-status="error" src="{{ App\Http\Controllers\ImageController::getViewImage($music->image) }}">
                        </div>
                    </div>
                ...
                <ul class="track__version">
                    <li class="track__version trakc-version">
                        ...
                        <div class="track-version__item track-item tracks__item track-item__{{ $music->id }} track-item__type_music" data-music="{{ App\Http\Controllers\MusicDownloadController::getLink($music->link, $music->link_demo, $music->is_free) }}" data-title="{{ $music->title }}" data-id="{{ $music->id }}" data-type="music" data-favorite="{{ $favorite($music?->favorite_id, $music->id, 'music') }}" data-artist="{{ $music->artist->artist_name }}" data-time="{{ App\Http\Controllers\MusicController::timeFullOrDemo($music->duration, $music->duration_demo, $music->is_free) }}">
                            <div class="track-item__timer">
                                <button class="track-button track-item__button">
                                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <g class="track-item__button_start">
                                            <path d="M15 25.509C15.0004 25.9876 15.1322 26.4559 15.3798 26.8581C15.6273 27.2602 15.9801 27.5793 16.3961 27.7771C16.812 27.9749 17.2735 28.0431 17.7254 27.9735C18.1774 27.904 18.6006 27.6996 18.9447 27.3849L27 20.0032L18.9447 12.6169C18.6008 12.3015 18.1775 12.0966 17.7254 12.0267C17.2732 11.9568 16.8114 12.0249 16.3952 12.2228C15.979 12.4207 15.6261 12.7401 15.3787 13.1426C15.1312 13.5452 14.9998 14.014 15 14.4928V25.509Z" fill="white"></path>
                                        </g>
                                        <g class="track-item__button_pause">
                                            <path d="M15.9998 13.6665V27.0002" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M24 13.6665V27.0002" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                        </g>
                                        <defs>
                                            <linearGradient id="paint0_linear_111_2751" x1="40" y1="0" x2="-3.72369" y2="4.59913" gradientUnits="userSpaceOnUse">
                                ...
                                <a class="track-item__info" href="/music/{{ $music->id }}" rel="noreferrer noopener" hidden=""></a>
                            </div>
                            ...
                            <div class="track-item__buttons">
                                ...
                                @endif
                                <a class="track-item__download" href="{{ App\Http\Controllers\MusicDownloadController::getLink($music->link, $music->link_demo, $music->is_free) }}" download="">
                                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_98_282)">
                                            <path d="M20.0007 13.125V23.125" stroke="#1B121E" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M16.2507 19.375L20.0007 23.125L23.7507 19.375" stroke="#1B121E" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M29.3757 23.125V24.375C29.3757 25.038 29.1123 25.6739 28.6435 26.1428C28.1747 26.6116 27.5388 26.875 26.8757 26.875H13.1257C12.4627 26.875 11.8268 26.6116 11.358 26.1428C10.8891 25.6739 10.6257 25.038 10.6257 24.375V23.125" stroke="#1B121E" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                        </g>
                                        <defs>
                                ...
                                <a class="track-item__buy" href="/pricing">
                                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_98_281)">
                                            <path d="M15 25.9374H23.2675C23.5627 25.9375 23.8485 25.833 24.0742 25.6424C24.2997 25.4519 24.4506 25.1877 24.5 24.8966L26.6975 11.9799C26.7471 11.689 26.898 11.4249 27.1236 11.2346C27.3492 11.0443 27.6348 10.9399 27.93 10.9399H28.75" stroke="#1B121E" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M16.5625 28.4375C16.3899 28.4375 16.25 28.2976 16.25 28.125C16.25 27.9524 16.3899 27.8125 16.5625 27.8125" stroke="#1B121E" stroke-width="1.5"></path>
                                            <path d="M16.5625 28.4375C16.7351 28.4375 16.875 28.2976 16.875 28.125C16.875 27.9524 16.7351 27.8125 16.5625 27.8125" stroke="#1B121E" stroke-width="1.5"></path>
                                            <path d="M22.8125 28.4375C22.6399 28.4375 22.5 28.2976 22.5 28.125C22.5 27.9524 22.6399 27.8125 22.8125 27.8125" stroke="#1B121E" stroke-width="1.5"></path>
                                            <path d="M22.8125 28.4375C22.9851 28.4375 23.125 28.2976 23.125 28.125C23.125 27.9524 22.9851 27.8125 22.8125 27.8125" stroke="#1B121E" stroke-width="1.5"></path>
                                            <path d="M24.9607 22.1875H14.9015C14.3441 22.1875 13.8027 22.0011 13.3633 21.658C12.9239 21.315 12.6118 20.835 12.4765 20.2942L11.2682 15.4609C11.2451 15.3687 11.2434 15.2725 11.2631 15.1795C11.2828 15.0866 11.3235 14.9994 11.382 14.9245C11.4405 14.8496 11.5152 14.789 11.6007 14.7474C11.6861 14.7058 11.7798 14.6842 11.8749 14.6842H26.2365" stroke="#1B121E" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                        </g>
                                        <defs>
                        ...
                        <li class="track__category_item category-item">
                            ...
                            <ul class="category-item__list">
                                @foreach ($music->instruments as $instrument)
                                    <li class="category-item__item">
                                        <a class="category-item__link text-medium" href="/tracks?instrument={{ $instrument->id }}">
                                            {{ $instrument->name }}
                                        </a>
                                    </li>
                                @endforeach
