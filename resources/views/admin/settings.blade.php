        ...
        <div>
            ...
            <form class="admin-form" action="{{ url()->current() }}" method="post" enctype="multipart/form-data">
                ...
                <div class="admin-form__flex">
                    ...
                    <label class="admin-label">
                        <span>Название*</span>
                        <input class="admin-input" type="text" name="name" value="{{ old('name') ?? $site->name }}"
                            required>
                        @error('name')
                            <span class="error">{{ $message }}</span>
                        @enderror
            ...
            <div class="admin-form">
                ...
                <form class="admin-form" action="{{ route('slider.setting') }}" method="post"
                    ...
                    <div class="admin-form__flex">
                        ...
                        <label class="admin-label">
                            <span>Заголовок слайдера</span>
                            <input class="admin-input" value="{{ $slider_config->slider_description }}" type="text"
                    ...
                    <div class="admin-form__flex">
                        <label class="admin-label">
                            ...
                            <input class="admin-input" value="{{ $slider_config->button_first_text }}" type="text"
                                name="slider_description">
                            @error('slider_description')
                                <span class="error">{{ $message }}</span>
                            @enderror
                        ...
                        <label class="admin-label">
                            ...
                            <input class="admin-input" value="{{ $slider_config->button_first_link }}" type="text"
                                name="slider_description">
                            @error('slider_description')
                                <span class="error">{{ $message }}</span>
                            @enderror
                        ...
                        <label class="admin-label">
                            ...
                            <input class="admin-input" value="{{ $slider_config->button_second_text }}" type="text"
                                name="slider_description">
                            @error('slider_description')
                                <span class="error">{{ $message }}</span>
                            @enderror
                        ...
                        <label class="admin-label">
                            ...
                            <input class="admin-input" value="{{ $slider_config->button_second_link }}" type="text"
                                name="slider_description">
                            @error('slider_description')
                                <span class="error">{{ $message }}</span>
                            @enderror
