            ...
            @foreach ($music_list as $music_item)
                <li class="admin-grid__content_item admin-grid-music__content_item">
                    ...
                    <a class="text-ellipsis"
                        title="{{ App\Http\Controllers\MusicUploadController::getViewLink($music_item->link) }}"
                        target="_blank"
                    ...
                    <a class="admin-button admin-button-edit" href="{{ route('music.edit', ['id' => $music_item->id]) }}">
