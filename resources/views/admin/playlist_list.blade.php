...
@section('html')
    ...
    <div class="admin-grid">
        <div class="admin-grid__inner">
            ...
            <ul class="admin-grid__content admin-grid-playlist__content">
                @foreach ($playlists as $playlist)
                    <li class="admin-grid__content_item admin-grid-playlist__content_item">
                        ...
                        <div>{{ App\Http\Controllers\RelationshipHelper::getNameByItems($playlist->instruments, '—') }}
                        </div>
                        ...
                        <a class="admin-button admin-button-edit" href="{{ route('playlist.edit', ['id' => $playlist->id]) }}">
            ...
            {{ $playlists->appends(Request::all())->links('vendor.admin-pagination') }}
        </div>
