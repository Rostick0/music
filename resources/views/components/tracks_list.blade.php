...
@if(empty($music_list))
<h3 class="tracks__none">Музыка не найдена</h3>
@else
<ul class="tracks__list">
    @foreach ($music_list as $music_item)
        <li class="tracks__item track-item">
            ...
            <div class="track-item__audio track-item__audio_{{ $music_item->id }}" data-music="{{ $music_item->link }}">
            </div>
                ...
                <a class="track-item__download"
                    ...
                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                        ...
                        <g clip-path="url(#clip0_98_282)">
                            <path d="M20.0007 13.125V23.125" stroke="#1B121E" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
