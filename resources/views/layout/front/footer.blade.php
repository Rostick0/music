        ...
        <div class="footer__container">
            ...
            <div class="footer__center">
                ...
                <ul class="footer__social">
                    <li class="footer__social_item youtube">
                        <a class="footer__social_link" href="https://youtube.com/@topflowproduction">
                    ...
                    <li class="footer__social_item">
                        <a class="footer__social_link instagram" href="https://instagram.com/topaudio.store/">
                    ...
                    <li class="footer__social_item">
                        <a class="footer__social_link facebook" href="https://facebook.com/topflowproduction/">
                            <svg width="41" height="40" viewBox="0 0 41 40" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
